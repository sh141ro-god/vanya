...
namespace delivery.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderStatusId,Name,Description")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderStatusId,Name,Description")] OrderStatus orderStatus)
        {
